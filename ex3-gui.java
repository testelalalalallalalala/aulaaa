...
public class Mavenproject223112 extends JFrame {
    ...
    private double num1, num2, resultado; // variáveis globais
    ...
    private void calcular(char operacao) {
        ...
        JOptionPane.showMessageDialog(this, "Resultado: " + String.format("%.2f", resultado),
